function calculateAge() {
    ...
    function updateAge() {
        ...
        document.getElementById('result').innerHTML = `Your age is : <span class='font-semibold'>${Math.round(years)}</span> years, <span class='font-semibold'>${remainingMonths}</span> Months and <span class='font-semibold'>${remainingDays}</span> days`;
